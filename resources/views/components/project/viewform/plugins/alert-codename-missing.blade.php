@if (empty($project->code_name))
    <div id="alert-4" class="flex p-4 bg-yellow-100 rounded-lg dark:bg-yellow-200" role="alert">
        ...
        <div class="ml-3 text-sm font-medium text-yellow-700 dark:text-yellow-800">
            Ce projet ne possède pas d'url car il ne possède pas de nom de code.
            <a class="underline" href="{{ route('project.update', $project->id) }}#code_name">Cliquez pour renseigner un nom de
                code
                et définir l'url.</a>
        </div>
    </div>
