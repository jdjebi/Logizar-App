<div>
    ...
    <div class="flex justify-between items-center flex-wrap mb-4 sm:mb-1">
        <div class="flex justify-between items-center">
            <div class="p-4">
                <h6 class="font-semibold">Types de projet</h6>
            </div>
        </div>
        <div class="pl-4">
            ...
            <x-slot name="rows">
                @foreach ($types as $type)  
                    <x-tables.simple-table.row class="odd:bg-white even:bg-gray-50">
                        ...
                        <x-tables.simple-table.td class="font-medium text-gray-900">{{ $type->name }}</x-tables.simple-table.td>
                        <x-tables.simple-table.td>{{ $type->shortname }}</x-tables.simple-table.td>
                        <x-tables.simple-table.td>{{ $type->description }}</x-tables.simple-table.td>
                        <x-tables.simple-table.td class="text-right">
                            <x-buttons.light wire:click='openUpdateModal({{ $type->id }})' href="javascript:void(0)" class="text-xs">Modifier</x-buttons>
                            <x-buttons.red wire:click='openDeleteModal({{ $type->id }})' href="javascript:void(0)" class="text-xs mr-0">Supprimer</x-buttons>
    ...
    <x-jet-modal wire:model="uiOpenCreateModal" maxWidth="md">
        <div class="relative bg-white rounded-lg shadow ">
            ...
            <div class="py-6 px-6 lg:px-8">
                <h3 class="mb-4 text-xl font-medium text-gray-900">Nouveau type</h3>
                <div>
    ...
    <x-jet-modal wire:model="uiOpenDeleteModal" maxWidth="sm">
        <div class="relative bg-white rounded-lg shadow ">
            ...
            <div class="py-6 px-6 lg:px-8">
                <h3 class="mb-4 text-xl font-medium text-gray-900">Supprimer le type</h3>
