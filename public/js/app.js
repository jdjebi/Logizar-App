...
window.Toast = sweetalert2__WEBPACK_IMPORTED_MODULE_2___default().mixin({
  toast: true,
  position: 'top',
...
window.addEventListener('alert', function (_ref) {
